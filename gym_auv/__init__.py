...
SCENARIOS = {
    ...
    "Sorbuoya-v0": {"entry_point": "gym_auv.envs:Sorbuoya", "config": REALWORLD_CONFIG},
    "Agdenes-v0": {"entry_point": "gym_auv.envs:Agdenes", "config": REALWORLD_CONFIG},
    "Trondheim-v0": {
    ...
    ##### THOMAS' CUSTOM ENVS #####
    "Env0-v0": {"entry_point": "gym_auv.envs:Env0", "config": MOVING_CONFIG},
    "Env1-v0": {"entry_point": "gym_auv.envs:Env1", "config": MOVING_CONFIG},
    "Env2-v0": {"entry_point": "gym_auv.envs:Env2", "config": MOVING_CONFIG},
    "Env3-v0": {"entry_point": "gym_auv.envs:Env3", "config": MOVING_CONFIG},
    "Env4-v0": {"entry_point": "gym_auv.envs:Env4", "config": MOVING_CONFIG},
    ##### Docking Enironments #####
